 ...
 */
final class Version20260217090402 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE essai_libre (id INT NOT NULL, circuit VARCHAR(100) NOT NULL, grand_prix VARCHAR(100) NOT NULL, session VARCHAR(10) NOT NULL, date_heure DATETIME NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE essai_libre_classement (id INT AUTO_INCREMENT NOT NULL, pilote VARCHAR(100) NOT NULL, position INT NOT NULL, temps VARCHAR(20) NOT NULL, essai_libre_id INT NOT NULL, INDEX IDX_4D1D551C56D08907 (essai_libre_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE pilote (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(100) NOT NULL, prenom VARCHAR(100) NOT NULL, nationalite VARCHAR(100) NOT NULL, date_naissance DATE DEFAULT NULL, numero INT DEFAULT NULL, photo VARCHAR(255) DEFAULT NULL, biographie LONGTEXT DEFAULT NULL, ecurie_id INT DEFAULT NULL, INDEX idx_pilote_ecurie_id (ecurie_id), INDEX idx_pilote_nom (nom), INDEX idx_pilote_numero (numero), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE qualification (id INT NOT NULL, circuit VARCHAR(100) NOT NULL, grand_prix VARCHAR(100) NOT NULL, date_heure DATETIME NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE qualification_classement (id INT AUTO_INCREMENT NOT NULL, pilote VARCHAR(100) NOT NULL, position INT NOT NULL, temps VARCHAR(20) NOT NULL, qualification_id INT NOT NULL, INDEX IDX_8B3353B31A75EE38 (qualification_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE sprint (id INT NOT NULL, circuit VARCHAR(100) NOT NULL, grand_prix VARCHAR(100) NOT NULL, date_heure DATETIME NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE sprint_classement (id INT AUTO_INCREMENT NOT NULL, pilote VARCHAR(100) NOT NULL, position INT NOT NULL, temps VARCHAR(20) NOT NULL, points INT NOT NULL, sprint_id INT NOT NULL, INDEX IDX_238D7C9B8C24077B (sprint_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE essai_libre');
        $this->addSql('DROP TABLE essai_libre_classement');
        $this->addSql('DROP TABLE pilote');
        $this->addSql('DROP TABLE qualification');
        $this->addSql('DROP TABLE qualification_classement');
        $this->addSql('DROP TABLE question');
        $this->addSql('DROP TABLE quiz');
        $this->addSql('DROP TABLE quiz_resultat');
        $this->addSql('DROP TABLE reponse');
        $this->addSql('DROP TABLE sprint');
        $this->addSql('DROP TABLE sprint_classement');
