 ...
 */
final class Version20260218180625 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ecurie ADD voiture_img VARCHAR(255) DEFAULT NULL, ADD pilote1 VARCHAR(100) DEFAULT NULL, ADD pilote1_img VARCHAR(255) DEFAULT NULL, ADD pilote2 VARCHAR(100) DEFAULT NULL, ADD pilote2_img VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ecurie DROP voiture_img, DROP pilote1, DROP pilote1_img, DROP pilote2, DROP pilote2_img');
