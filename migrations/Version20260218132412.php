 ...
 */
final class Version20260218132412 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE resume_video (id INT AUTO_INCREMENT NOT NULL, titre VARCHAR(255) NOT NULL, url VARCHAR(255) NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE resume_video');
