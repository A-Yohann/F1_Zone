 ...
 */
final class Version20260218185807 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ecurie_pilote (ecurie_id INT NOT NULL, pilote_id INT NOT NULL, INDEX IDX_580BCF2357F92A74 (ecurie_id), INDEX IDX_580BCF23F510AAE9 (pilote_id), PRIMARY KEY (ecurie_id, pilote_id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE ecurie DROP pilote1, DROP pilote1_img, DROP pilote2, DROP pilote2_img');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE ecurie_pilote');
        ...
        $this->addSql('ALTER TABLE ecurie ADD pilote1 VARCHAR(100) DEFAULT NULL, ADD pilote1_img VARCHAR(255) DEFAULT NULL, ADD pilote2 VARCHAR(100) DEFAULT NULL, ADD pilote2_img VARCHAR(255) DEFAULT NULL');
