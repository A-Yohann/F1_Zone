 ...
 */
final class Version20260218104133 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE circuits ADD image_avif VARCHAR(100) DEFAULT NULL, CHANGE image_name image_svg VARCHAR(100) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE circuits ADD image_name VARCHAR(100) DEFAULT NULL, DROP image_svg, DROP image_avif');
