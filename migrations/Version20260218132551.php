 ...
 */
final class Version20260218132551 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commentaire ADD resume_video_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_67F068BC87262ABB ON commentaire (resume_video_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_67F068BC87262ABB ON commentaire');
        $this->addSql('ALTER TABLE commentaire DROP resume_video_id');
