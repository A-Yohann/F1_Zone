 ...
 */
final class Version20260219090708 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ecurie ADD directeur_nom VARCHAR(100) DEFAULT NULL, ADD directeur_img VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ecurie DROP directeur_nom, DROP directeur_img');
